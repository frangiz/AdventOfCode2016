	...
	internal class Day5Test
	{
		...
		public void AnswerB()
		{
			Assert.AreEqual(new char[] { '1', '0', '5', '0', 'c', 'b', 'b', 'd' },
				Day5.FindPassword("ojvtpuvg", 8, true));
		}
	}
}
